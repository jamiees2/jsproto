...
(function (global, factory) {
  ...
  $root.Test = (function () {
    ...
    Test.verify = function verify(message) {
      ...
      if (message.uint32 != null && message.hasOwnProperty('uint32'))
        if (!$util.isInteger(message.uint32)) return 'uint32: integer expected';
      if (message.inner != null && message.hasOwnProperty('inner')) {
        var error = $root.Test.Inner.verify(message.inner);
        if (error) return 'inner.' + error;
      }
      if (message.float != null && message.hasOwnProperty('float'))
        if (typeof message.float !== 'number') return 'float: number expected';
      return null;
    };
    ...
    Test.fromObject = function fromObject(object) {
      if (object instanceof $root.Test) return object;
      var message = new $root.Test();
      if (object.string != null) message.string = String(object.string);
      if (object.uint32 != null) message.uint32 = object.uint32 >>> 0;
      ...
      if (object.float != null) message.float = Number(object.float);
      return message;
    };
    ...
    Test.toObject = function toObject(message, options) {
      ...
      if (message.float != null && message.hasOwnProperty('float'))
        object.float =
          options.json && !isFinite(message.float)
    ...
    Test.Inner = (function () {
      ...
      Inner.encode = function encode(message, writer) {
        ...
        if (
          message.int32 != null &&
          Object.hasOwnProperty.call(message, 'int32')
        )
        ...
        if (
          message.outer != null &&
          Object.hasOwnProperty.call(message, 'outer')
        )
          $root.Outer.encode(
            message.outer,
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
      ...
      Inner.verify = function verify(message) {
        ...
        if (message.int32 != null && message.hasOwnProperty('int32'))
          if (!$util.isInteger(message.int32)) return 'int32: integer expected';
        if (
          message.innerInner != null &&
          message.hasOwnProperty('innerInner')
        ) {
          var error = $root.Test.Inner.InnerInner.verify(message.innerInner);
          if (error) return 'innerInner.' + error;
        }
        if (message.outer != null && message.hasOwnProperty('outer')) {
          var error = $root.Outer.verify(message.outer);
          if (error) return 'outer.' + error;
        }
        return null;
      };
      ...
      Inner.fromObject = function fromObject(object) {
        if (object instanceof $root.Test.Inner) return object;
        var message = new $root.Test.Inner();
        if (object.int32 != null) message.int32 = object.int32 | 0;
        if (object.innerInner != null) {
          if (typeof object.innerInner !== 'object')
            throw TypeError('.Test.Inner.innerInner: object expected');
          message.innerInner = $root.Test.Inner.InnerInner.fromObject(
            object.innerInner
          );
        }
      ...
      Inner.toObject = function toObject(message, options) {
        ...
        if (message.innerInner != null && message.hasOwnProperty('innerInner'))
          object.innerInner = $root.Test.Inner.InnerInner.toObject(
            message.innerInner,
            options
          );
        if (message.outer != null && message.hasOwnProperty('outer'))
      ...
      Inner.InnerInner = (function () {
        ...
        InnerInner.encode = function encode(message, writer) {
          ...
          if (
            message.long != null &&
            Object.hasOwnProperty.call(message, 'long')
          )
        ...
        InnerInner.fromObject = function fromObject(object) {
          if (object instanceof $root.Test.Inner.InnerInner) return object;
          var message = new $root.Test.Inner.InnerInner();
          if (object.long != null)
            if ($util.Long)
              (message.long = $util.Long.fromValue(
                object.long
              )).unsigned = false;
          ...
          if (object.sint32 != null) message.sint32 = object.sint32 | 0;
          return message;
        };
  ...
  $root.Outer = (function () {
     ...
     * @property {Uint8Array|null} [bytes] Outer bytes
     */
     ...
     * @instance
     */
    Outer.prototype.bytes = $util.newBuffer([]);
    ...
    Outer.verify = function verify(message) {
      ...
      if (message.bool != null && message.hasOwnProperty('bool')) {
        if (!Array.isArray(message.bool)) return 'bool: array expected';
        for (var i = 0; i < message.bool.length; ++i)
    ...
    Outer.fromObject = function fromObject(object) {
      if (object instanceof $root.Outer) return object;
      ...
      if (object.double != null) message.double = Number(object.double);
    ...
    Outer.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.arrays || options.defaults) object.bool = [];
      if (options.defaults) {
        object.double = 0;
      ...
      if (message.double != null && message.hasOwnProperty('double'))
        object.double =
          options.json && !isFinite(message.double)
