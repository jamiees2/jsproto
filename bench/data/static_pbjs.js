...
export const Test = $root.Test = (() => {
    ...
    Test.decode = function decode(reader, length) {
        ...
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Test();
    ...
    Test.verify = function verify(message) {
        ...
        if (message.inner != null && message.hasOwnProperty("inner")) {
            let error = $root.Test.Inner.verify(message.inner);
            if (error)
                return "inner." + error;
        }
        if (message.float != null && message.hasOwnProperty("float"))
    ...
    Test.Inner = (function() {
        ...
        Inner.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Test.Inner();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Inner.verify = function verify(message) {
            ...
            if (message.innerInner != null && message.hasOwnProperty("innerInner")) {
                let error = $root.Test.Inner.InnerInner.verify(message.innerInner);
                if (error)
                    return "innerInner." + error;
            }
            if (message.outer != null && message.hasOwnProperty("outer")) {
                let error = $root.Outer.verify(message.outer);
                if (error)
                    return "outer." + error;
            }
            return null;
        ...
        Inner.fromObject = function fromObject(object) {
            if (object instanceof $root.Test.Inner)
                return object;
            let message = new $root.Test.Inner();
        ...
        Inner.InnerInner = (function() {
            ...
            InnerInner.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Test.Inner.InnerInner();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            InnerInner.fromObject = function fromObject(object) {
                if (object instanceof $root.Test.Inner.InnerInner)
                    return object;
                let message = new $root.Test.Inner.InnerInner();
                if (object.long != null)
                    if ($util.Long)
...
export const Outer = $root.Outer = (() => {
    ...
    Outer.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.Outer();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
